...
import mobiusStripWorldSource from "../examples/mobius-strip.world.js?raw";
...
export const mobiusStrip = compileExampleWorld(mobiusStripWorldSource, "mobius-strip.world.js");
